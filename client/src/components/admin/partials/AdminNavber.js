      ...
      <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full bg-white">
        ...
        <div className="flex items-center">
          ...
          >
            ...
            <div className="userDropdown absolute right-0 mt-1 bg-gray-200 rounded shadow-md">
              <ul className="flex flex-col text-gray-700">
                <li>
                  <button
                    onClick={(e) => history.push("/")}
                    className="w-full text-left flex items-center space-x-2 py-2 px-6 hover:bg-gray-300 cursor-pointer"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="none"
